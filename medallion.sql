...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Apr 2021 pada 17.11
...
-- Database: `db-oprec`
--
CREATE DATABASE IF NOT EXISTS `db-oprec` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db-oprec`;
...
('000000', 'muhammad daffa', 2018, 'Bogor', '2001-01-30', 'mdaffa@Gmail.com', 101),
('09021181823002', 'MUHAMMAD SYAUGI', 2018, 'Palembang', '2000-10-31', 'Syaugi@unsri.ac.id\r\n', 101),
('09021181823007', 'ALDI ANUGRAHA PRATAMA', 2018, 'Palembang', '2000-10-31', 'aldinugraha@unsri.ac.id', 102),
('09021181823010', 'CINDY STEFFANI', 2018, 'Palembang', '2000-10-31', 'Cindysteffani@unsri.ac.id', 103),
('09021181823013', 'MELKY YURDIANSYAH', 2018, 'Palembang', '2000-10-31', 'Melky@unsri.ac.id', 104),
('09021181823015', 'DAFFA NAUFAL', 2018, 'Palembang', '2000-01-30', 'daffaa@unsri.ac.id', 0),
('09021181823016', 'AMELIA PUTRI', 2018, 'Palembang', '2002-05-10', 'amelia@unsri.ac.id', 0);
...
(1, 110291, 'AZAMI ABDUL MALIK', 'Pria', 'Sistem Komputer', 'Jl.Merbabu', 'azami@unsri.ac.id'),
(101, 1108401, 'ADE DWI SASANTI', 'Pria', 'Sistem Informasi', 'Jl. Merbabu ', 'ade@unsri.ac.id'),
(102, 1108402, 'BAMBANG YUDONO', 'Pria', 'Sistem Informasi', 'Jl. Semeru ', 'Bambang@unsri.ac.id'),
(103, 1108403, 'YUNITA', 'Wanita', 'Teknik Informatika', 'Jl.Kertapati ', 'Yunita@unsri.ac.id'),
(104, 1108404, 'DESTY RODIAH', 'Wanita', 'Teknik Informatika', 'Jl. Ogan ', 'Desty@unsri.ac.id'),
(106, 1108406, 'MUHAMMAD ZAKARIA', 'Pria', 'Sistem Komputer', 'Jl.Kerinci ', 'Zakaria@unsri.ac.id');
...
(1, '2020-10-12 09:46:55', 'Azam', 2010, 'Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui.'),
(2, '2020-10-12 09:46:55', 'Husei', 2011, 'Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui.'),
(3, '2020-10-12 09:46:55', 'Dina', 2013, 'Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui.'),
(4, '2020-10-12 09:46:55', 'Rehan', 2014, 'Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui.');
...
-- Database: `dbif3regc`
--
CREATE DATABASE IF NOT EXISTS `dbif3regc` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbif3regc`;
...
('09021281924039', 'AMELIA PUTRI');
--
-- Database: `db_alamat`
--
CREATE DATABASE IF NOT EXISTS `db_alamat` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_alamat`;
...
INSERT INTO `tb_alamat` (`no_ktp`, `nama`, `alamat`) VALUES
('173956557298991', 'Muhammad Daffa', 'Jl. Kebun'),
('173956557298992', 'Ari Fernandes', 'Jl. Permata hati No 55'),
('173956557298996', 'Puji Astuti', 'Jl. Puncak Sekuning'),
('173956557298997', 'Budi Susanto', 'Jl. Jendral Sudirman');
...
INSERT INTO `tb_buku` (`id_tamu`, `nama`, `nim`, `fakultas`, `angkatan`, `alamat`) VALUES
('C1', 'Ansellma Putri', '01011381', 'Ekonomi', 2017, 'Jl. Merpati'),
('C10', 'Fania Putri', '01011389', 'Kebudayaan', 2018, 'Jl. Puncak Sekuning'),
('C12', 'Nadiah Khania', '01011386', 'Komputer', 2019, 'Jl. Cempaka'),
('C8', 'Shabila Putri', '01011382', 'Ilmu Politik', 2019, 'Jl. Merbabu');
...
(0, 'risma03', '$2y$10$smfWcMk/mx9MI2e5qbKZbet2KWdlD6EkXGEbv/YIaCR3grCHXwcd6'),
(0, 'dapi', '$2y$10$EfhACJnYfAu4UBgaF42nV.7RefbXnF7RDsm/lY5cS7lxHkNZmzsIu'),
(0, 'buntu25', '$2y$10$rft9YscIS/KV.NLfqR7n9OlR5XAeQECHfv2BHg9k13GD9lOwfcqey'),
(0, 'ameliaputri', '$2y$10$R/6FZEOOONYYdKytN0N7ge2FdIbwIQdCRpu0riRKSrvAcXrt86xOy');
...
-- Database: `if3regc`
--
CREATE DATABASE IF NOT EXISTS `if3regc` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `if3regc`;
...
CREATE TABLE `tbl_dosen` (
  ...
  `pangkat` varchar(15) DEFAULT 'n/a',
  `email` varchar(75) DEFAULT 'n/a',
  `golongan` varchar(5) DEFAULT 'n/a',
  `jabfung` varchar(20) DEFAULT 'n/a',
  `nip_kerabat` varchar(20) DEFAULT NULL,
  `relasi` enum('n/a','istri','suami') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_dosen` (`nip`, `nama`, `alamat_rumah`, `pangkat`, `email`, `golongan`, `jabfung`, `nip_kerabat`, `relasi`) VALUES
('D01', 'Eko Prasetyo', 'Kenten', 'n/a', 'n/a', 'n/a', 'n/a', 'D03', 'suami'),
('D02', 'Eko Sungkono', 'Bukit Lama', 'n/a', 'n/a', 'n/a', 'n/a', NULL, NULL),
('D03', 'Firdayuni', 'Lemabang', 'n/a', 'n/a', 'n/a', 'n/a', 'D01', 'istri'),
('D04', 'Jokowi', 'Bukit Lama', 'n/a', 'n/a', 'n/a', 'n/a', NULL, NULL);
...
CREATE TABLE `tbl_mhs` (
  ...
  `nip_dosbing` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_mhs` (`nim`, `nama`, `alamat`, `angkatan`, `email`, `tgl_lahir`, `nip_dosbing`) VALUES
('0902001', 'Adi', 'Tanggo Buntung', 0, 'n/a', '2000-01-30', 'D01'),
('0902002', 'Budi', 'Kertapati', 0, 'n/a', '2000-05-15', 'D02'),
('0902003', 'Candi', 'Plaju', 0, 'n/a', '2000-11-10', 'D04'),
('0902004', 'Dedi', 'Bukit Lama', 0, 'n/a', '2000-01-30', 'D01'),
('0902005', 'Edo', 'Plaju', 0, 'n/a', '2000-08-17', 'D01');
...
ALTER TABLE `tbl_dosen`
  ADD PRIMARY KEY (`nip`),
  ADD KEY `nip_kerabat` (`nip_kerabat`);
...
ALTER TABLE `tbl_mhs`
  ADD PRIMARY KEY (`nim`),
  ADD KEY `nip_dosbing` (`nip_dosbing`);
...
-- Database: `ktp`
--
CREATE DATABASE IF NOT EXISTS `ktp` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ktp`;
...
INSERT INTO `tb_ktp` (`id`, `no_ktp`, `nama`, `alamat`, `kelurahan`, `kecamatan`, `kota`) VALUES
(1, '24367', 'Susanti', 'Jl. Permata Hati No. 55', '2 Ilir', 'Bukit Besar', 'Bandung'),
(2, '34567', 'Budi Susanto', 'Jl. Jendral Sudirman', '1 ilir', 'Bukit Kecil', 'Palembang'),
(3, '67890', 'Ari Fernandes', 'Jl. Puncak Sekuning', '12 Ilir', 'Kertapati', 'Lampung');
...
(1, 'Budi Susanto', 'Jl. Jendral Sudirman', 'Pria', '1988-07-12', 'Teknik Informatika', 'Programming, Desain, Olahraga'),
(2, 'Susanti', 'Jl. Permata Hati No. 55', 'Wanita', '1990-09-13', 'Sistem Informasi', 'Desain'),
(3, 'Ari Fernandes', 'Jl. Puncak Sekuning', 'Pria', '1996-10-24', 'Teknik Informatika', 'Programming, Olahraga'),
(4, 'Pandawa', 'Jl. Cinta Damai', 'Pria', '1994-05-04', 'Sistem Komputer', 'Desain, Olahraga'),
(6, 'ani', 'Jakabaring', 'Pria', '2002-05-07', 'Teknik Informatika', 'Desain,OlahRaga');
...
--
-- Struktur dari tabel `accomodation`
--
...
--
-- Dumping data untuk tabel `accomodation`
--
...
(2, 'Adawiyyah', '071137371', 'lalalal@yahoo.com', 'adaw', 16, 'Female', '2021-04-14', 1, 3, 1, '607abda7e9adb'),
(3, 'adinda', '0811365900', 'aku@gmail.com', 'dinda', 19, 'Female', '2021-04-21', 1, 3, 1, '607afbc16b3d4'),
(4, 'nadia', '098877666', 'hahahha@gmail.com', 'nadia', 12, 'Female', '2021-04-18', 1, 6, 1, '607afe8c37f4a'),
(5, 'nadia', '098877666', 'hahahha@gmail.com', 'vino', 12, 'Male', '2021-04-18', 1, 6, 1, '607afe8c37f4a'),
(6, 'epi', '089212647', 'haha@gmail.com', 'epija', 15, 'Female', '2021-04-13', 1, 4, 1, '607affa66f5aa'),
(7, 'q', 'q', 'q', 'q', 12, 'Male', '2021-04-08', 2, 4, 5, '607b0a40bdd87'),
(8, 'wawa', '09899876', 'wwaa@Gmail.com', 'wawa', 12, 'Female', '2021-04-28', 5, 2, 6, '607d35bf826a3'),
(9, 'a', 'a', 'a', 'a', 12, 'Male', '2021-04-28', 5, 2, 6, '607d35bf826a3'),
(10, 'a', 'a', 'a', 'a', 12, 'Male', '2021-04-28', 5, 2, 6, '607d35bf826a3'),
(11, 'a', 'a', 'a', 'Amelia Putri', 11, 'Male', '2021-04-21', 1, 1, 1, '607d3e920b808'),
(12, 'aq', '12345', 'aaa', 'Amelia Putri', 14, 'Male', '2021-04-14', 3, 2, 5, '607da170f15d5'),
(13, 'a', 'a', 'a', 'Amelia Putri', 12, 'Male', '2021-04-14', 3, 2, 5, '607da170f15d5'),
(14, 'a', 'a', 'a', 'Amelia Putri', 14, 'Male', '2021-04-14', 3, 2, 5, '607da170f15d5'),
(15, 'a', '081888', 'amel', 'Amelia Putri', 12, 'Male', '2021-04-20', 4, 6, 3, '607dab325c1f0');
...
(3, '2021-04-17 10:50:26', 390, 'Amelia', 19, 'Female', 3, 5, 4, 1, 0);
...
--
-- Indeks untuk tabel `accomodation`
--
...
--
-- AUTO_INCREMENT untuk tabel `accomodation`
--
ALTER TABLE `accomodation`
...
--
ALTER TABLE `destination`
  MODIFY `dest_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT untuk tabel `origin`
--
ALTER TABLE `origin`
  MODIFY `origin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
CREATE TABLE `pelanggan` (
  ...
  `Nama` varchar(100) DEFAULT NULL,
  `Nomor_Telp` int(11) DEFAULT NULL,
...
CREATE TABLE `peminjaman` (
  ...
  `LamaPinjam` varchar(15) DEFAULT NULL,
...
--
CREATE DATABASE IF NOT EXISTS `swarakalibata` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `swarakalibata`;
...
-- Database: `tamu`
--
CREATE DATABASE IF NOT EXISTS `tamu` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tamu`;
...
INSERT INTO `tb_tamu` (`id_tamu`, `nama`, `nim`, `angkatan`, `fakultas`, `alamat`) VALUES
('A11', 'Ansellma Putri', 1011381, '2018', 'Ekonomi', 'Jl. Jendral Sudirman'),
('C6', 'Puji Astuti', 1011386, '2019', 'Ilmu Politik', 'Jl. Permata Hati No. 55'),
('F8', 'Ari Fernandes', 1011380, '2013', 'Komputer', 'Jl. Puncak Sekuning');
...
INSERT INTO `user` (`id`, `username`, `password`) VALUES
(0, 'dapi', '$2y$10$csBfBM.LtD4pRhEVIu5h4O.8P0cIuxeH00WawhPtBO/'),
(0, 'risma03', '$2y$10$9sZdSbjneKXv1j3/zVI.ye6uoLiJKnLZnYOeAR0zfS8');
